          ...
          <ul class="tabs rn-award-list">
            <li>
              <a
                ...
                target="_blank"
                >Awwwards.com <span>- Winner</span></a
              >
              2010 - 2011
            </li>
            <li>
            ...
            <li>
              <a
                ...
                target="_blank"
                >Design nominees <span>- site of the day</span></a
              >
              2013- 2014
            </li>
            <li>
              <a
                ...
                target="_blank"
                >CSS Design Awards <span>- Winner</span></a
              >
              2015 - 2016
            </li>
            <li>
              <a
                ...
                target="_blank"
                >UI/UX Design Awards <span>- Winner</span></a
              >
              2016 - 2017
            </li>
          </ul>
  ...
  export default {
    data() {
      return {
        ...
        src4: require("../assets/img/multiverses/logo.png"),
      };
    },
  };
</script>
